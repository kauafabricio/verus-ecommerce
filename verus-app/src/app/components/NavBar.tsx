     ...
     {/* NAV */}
      <nav className="h-[5rem] w-full flex px-8 justify-between items-center fixed z-10 nav sm:justify-around sm:px-0">
        ...
        <div className="flex items-center gap-2">
          <button aria-label="Carrinho de Compras" className="p-2 flex items-center">
          ...
          <button aria-label="Área do Usuário" className="p-2 flex items-center">
          ...
          <button aria-label="Abrir menu" onClick={() => setMenu(true)} className="sm:hidden flex items-center p-2">
